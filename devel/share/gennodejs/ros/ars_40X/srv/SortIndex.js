...
class SortIndexRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SortIndexRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SortIndexRequest
    let len;
    let data = new SortIndexRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SortIndexRequest(null);
...
class SortIndexResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SortIndexResponse
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SortIndexResponse
    let len;
    let data = new SortIndexResponse(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SortIndexResponse(null);
    return resolved;
    }
};

module.exports = {
  Request: SortIndexRequest,
  Response: SortIndexResponse,
  md5sum() { return '93fb6a7e64dbd2a0708217b8ad8f0eb8'; },
  datatype() { return 'ars_40X/SortIndex'; }
};
