...
//                                         object.relative_velocity.twist.linear.y));
    std::string vel_x = std::to_string(object.relative_velocity.twist.linear.x);
    std::string vel_y = std::to_string(object.relative_velocity.twist.linear.y);
    velocity.text = vel_x + ", " + vel_y;
